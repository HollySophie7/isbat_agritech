...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $apiKey = 'atsk_b8d45b359f3a13af7e0962ad5a343cc1e283efedd61ba13b0de4ea2f79f493ded5380661'; // Your API key
...
<script>
    ...
    document.getElementById('cropForm').onsubmit = function(event) {
        ...
        if (suitableCrops.length > 0) {
            ...
            document.getElementById('comparisonResult').value = 'Crops suitable for the current conditions have been found.';
        } else {
            const li = document.createElement('li');
