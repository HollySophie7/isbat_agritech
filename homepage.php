...
<body>
    <div class="dashboard-container">
        <header class="dashboard-header">
            ...
            <h1>Welcome, <?php echo htmlspecialchars($_SESSION['user']['username']); ?>!<br>
                <i style="font-size:1.4rem;">Smart irrigation, Smart farming </i>
            </h1>
            <nav class="nav">
            ...
            <div class="dashboard-actions">
                <div id="dashboard-content" class="content-section" style="display: block;">
                    ...
                    <div class="dashboard-grid">
                        ...
                        <div class="dashboard-item" id="section4">
